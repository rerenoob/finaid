...
namespace finaid.Migrations
{
    ...
    [Migration("20250901140330_FixUserDocumentSchema")]
    partial class FixUserDocumentSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("finaid.Data.Entities.DocumentVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("RequiredCorrections")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("VerificationChecks")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("finaid.Data.Entities.OCRProcessingResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("OCRProcessingResults");
                });

            modelBuilder.Entity("finaid.Data.Entities.UserDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("finaid.Data.Entities.DocumentVerification", b =>
                {
                    b.HasOne("finaid.Data.Entities.UserDocument", "Document")
                        .WithMany()
            ...
            modelBuilder.Entity("finaid.Data.Entities.OCRProcessingResult", b =>
                {
                    b.HasOne("finaid.Data.Entities.UserDocument", "Document")
                        .WithOne("OCRResult")
                        .HasForeignKey("finaid.Data.Entities.OCRProcessingResult", "DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
